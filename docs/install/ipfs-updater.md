...
1. Download the Windows binary from [`dist.ipfs.io`](https://dist.ipfs.io/#ipfs-update).
   ...
   ```powershell
   cd ~
   wget https://dist.ipfs.io/ipfs-update/v1.9.0/ipfs-update_v1.9.0_windows-amd64.zip -Outfile ipfs-update_v1.9.0_windows-amd64.zip
   ```
...
1. Download the macOS binary from [`dist.ipfs.io`](https://dist.ipfs.io/#ipfs-update).
   ...
   ```bash
   curl -O https://dist.ipfs.io/ipfs-update/v1.9.0/ipfs-update_v1.9.0_darwin-amd64.tar.gz
   ```
...
1. Download the Linux binary from [`dist.ipfs.io`](https://dist.ipfs.io/#ipfs-update).
   ...
   ```bash
   wget https://dist.ipfs.io/ipfs-update/v1.9.0/ipfs-update_v1.9.0_linux-amd64.tar.gz
   ```
